...
import IconGithub from "../icons/IconPlay";
...
export default component$(() => {
  ...
  return (
    <>
      <header
        id="header"
        class={`sticky top-0 py-0.5  z-40 max-w-7xl bg-background flex-none mx-auto w-full border-gray-200 dark:border-gray-700 transition-[opacity] ease-in-out ${
          store.isScrolling
          ...
          <div class="mr-auto rtl:mr-0 rtl:ml-auto flex justify-between">
            ...
            <div class="flex items-center md:hidden gap-0.5">
              <button
                ...
                onClick$={toggleAudio}
              >
                {isPlaying.value ? <IconPause /> : <IconGithub />}
              </button>

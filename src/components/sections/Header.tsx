...
export default component$(() => {
  ...
  return (
    <>
      <header
        id="header"
        class={`sticky top-0 py-1 -mt-0.5 z-40 max-w-7xl bg-background flex-none mx-auto w-full border-gray-200 dark:border-gray-700 transition-[opacity] ease-in-out ${store.isScrolling
